...
//--               アイテム　HPポーション               --
//--====================================================--
public class HP_Potion : Items
{
    public static readonly ItemData item_data = EigenValue.ITEM_HP_POTION;
    ...
    public override bool Use()
    {
        ...
        // 使用アイテムが上に飛んでくモーションの後にHP回復とエフェクト発生
        effect.transform.DOLocalMoveY(20f, 0.5f).SetEase(Ease.OutCirc).OnComplete(() =>
        {
            ...
            chara_cp.ReductHP(-5);
            player.transform.Find("EF_HPregene").gameObject.SetActive(true);
            effect.SetActive(false);
        }
        );
